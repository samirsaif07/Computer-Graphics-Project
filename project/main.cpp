...
float posy=15,posz=20,poszb=20;
...
void gameover()
{
    ...
    sdt.drawText("-----------------------Press Y/y to play again------------------------", 0, 250, 1, 1, 1);
...
static void idle(void)
{
    ...
    else
    {
        ...
        else
        {
            ...
            {
                //cout<<posz-(poszb+(bsize/2))<<" "<<bsize/2<<endl;
                if(balltype==8)
                {

                    // cout<<"balltype8 "<<go<<endl;
...
//    glClearColor(1,1,1,1);
    ...
    LoadTexture("F:\\Graphics project\\project\\project\\wall2.bmp");
    LoadTexture("F:\\Graphics project\\project\\project\\wall2.bmp");
    LoadTexture("F:\\Graphics project\\project\\project\\bucket.bmp");
    LoadTexture("F:\\Graphics project\\project\\project\\bucket.bmp");
    LoadTexture("F:\\Graphics project\\project\\project\\bucket.bmp");
